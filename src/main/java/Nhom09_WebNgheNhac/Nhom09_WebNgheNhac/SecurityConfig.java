    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/css/**", "/js/**", "/", "/oauth/**", "/user/register", "/error", "/" ,"/user/login" ,"/category" , "/singer", "/song/edit/**", "/song/add", "/song/delete" ,"/category/edit/**" , "/category/add" , "/category/delete" ,"/singer/edit/**" , "/singer/add" , "/singer/delete")
                ...
                .logout(logout -> logout
                        ...
                        .logoutSuccessUrl("/user/login") // Trang chuyển hướng sau khi đăng xuất.
                ...
                .formLogin(formLogin -> formLogin
                        .loginPage("/user/login") // Trang đăng nhập.
                ...
                .sessionManagement(sessionManagement -> sessionManagement
                        ...
                        .expiredUrl("/user/login") // Trang khi phiên hết hạn.
                )
