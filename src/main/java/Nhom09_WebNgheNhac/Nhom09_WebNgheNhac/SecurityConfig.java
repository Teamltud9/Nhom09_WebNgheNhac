    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/song/edit/**", "/song/add", "/song/delete" ,"/category/edit/**" , "/category/add" , "/category/delete" ,"/singer/edit/**" , "/singer/add" , "/singer/delete","/categoryplaylist","/categoryplaylist/add")
